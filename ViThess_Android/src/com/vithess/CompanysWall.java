...
public class CompanysWall extends Fragment {
	
	ListView companysListView ;
	View view;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		view = inflater.inflate(R.layout.companys_wall, container, false);
		initializeList();       
	...
	private void initializeList() {
        ...
        companysListView = (ListView) view.findViewById(R.id.companys_list);
 
        // 3. Assign adapter to ListView
        companysListView.setAdapter(maa);        
	...
	public void loadMessages(String result) {
		try {
			...
			for(int i=0;i<json.length();i++){    
			    ...
			    String address  = e.getString("company_address");
			    String company_name = e.getString("company_name");
			    String date = e.getString("message_creation_timestamp");
			    //String category = e.getString("category_name");
	
			    Message msg =new Message (message_id, message_title, message_text, message_up_votes,
			    		message_down_votes, message_views, distance, company_name, address, date);
			    messages.add(msg);
			}
