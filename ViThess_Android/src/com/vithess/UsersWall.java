...
public class UsersWall extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		view = inflater.inflate(R.layout.users_wall, container, false);
		initializeList();       
	...
	public void loadMessages(String result) {
		try {
			...
			for(int i=0;i<json.length();i++){    
			    ...
			    String userName= e.getString("person_username");
			    ...
			    Message msg =new Message (message_id, message_title, message_text, message_up_votes,
			    		message_down_votes, message_views, distance, userName,"",date);
			    messages.add(msg);
			}
